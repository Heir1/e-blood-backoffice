<script src="{{asset('backend/admin/js/jquery-2.2.4.min.js')}}"></script>
...
<script src="{{asset('backend/admin/js/jquery.fancybox.pack.js')}}"></script>
<script src="{{asset('backend/admin/js/app.min.js')}}"></script>
<script src="{{asset('backend/admin/js/jscolor.js')}}"></script>
<script src="{{asset('backend/admin/js/on-off-switch.js')}}"></script>
<script src="{{asset('backend/admin/js/on-off-switch-onload.js')}}"></script>
